...
import TopAuctionsByBidsChart from "../components/charts/TopAuctionsByBidsChart";
...
const AdminAdd = () => {
  ...
  type Tab = "dashboard" | "lists" | "users";
        ...
        <div className="dashboard-shell">
          <div className="dashboard-header">
            <div>
              ...
              <p className="dashboard-sub">Upravljanje aukcijama, proizvodima i kategorijama</p>
            </div>
          ...
          <div className="dashboard-body">
            <div className="dashboard-nav">
              <div
                className={`nav-dot ${activeTab === "dashboard" ? "active" : ""}`}
              ...
              <div
                className={`nav-dot ${activeTab === "lists" ? "active" : ""}`}
                onClick={() => setActiveTab("lists")}
                title="Aukcije / Proizvodi / Kategorije"
              >
                🔨
              </div>

              <div
                className={`nav-dot ${activeTab === "users" ? "active" : ""}`}
                onClick={() => setActiveTab("users")}
                title="Korisnici / Bidovi"
              >
                👥
              </div>
            </div>
                ...
                <>
                  <div className="stats-grid">
                    <div className="stat-card">
                      ...
                      <div className="hint">Sve aukcije u sistemu</div>
                    </div>

                    <div className="stat-card">
                      <div className="label">Ukupno proizvoda</div>
                      <div className="value">{products.length}</div>
                      <div className="hint">Proizvodi na platformi</div>
                    </div>

                    <div className="stat-card">
                      <div className="label">Ukupno bidova</div>
                      <div className="value">{allBids.length}</div>
                      <div className="hint">Ponude korisnika</div>
                    </div>

                    <div className="stat-card">
                      <div className="label">Ukupno korisnika</div>
                      <div className="value">{users.length}</div>
                      <div className="hint">Registrovani nalozi</div>
                    </div>
                  </div>
                  <div className="panels-grid">
                    <div className="panel">
                      <div className="panel-title">
                        <h2>Bidovi na top aukcijama</h2>
                        <span className="small">Google Charts</span>
                      </div>
                      <div className="panel-content">
                       <TopAuctionsByBidsChart auctions={auctions} bids={allBids} topN={6} />
                      </div>
                    </div>
                    ...
                    <div className="panel">
                      <div className="panel-title">
                        <h2>Top aukcije</h2>
                        <span className="small">po broju bidova</span>
                      </div>
                      <div className="panel-content">
